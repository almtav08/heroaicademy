...
from game_structure import Unit
...
# region Methods
    ...
    def move_unit(self, unit: 'Unit', pos: Tuple[int, int]):
...
# region Getters
    ...
    def get_crystals(self) -> List['Unit']:
        """Get all crystals."""
    ...
    def get_units_in_range(self, other: 'Unit') -> List['Unit']:
